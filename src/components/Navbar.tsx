  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 flex justify-center p-6">
      <div className="glass flex items-center justify-between w-full max-w-7xl px-8 py-4 rounded-2xl">
        ...
        {/* Mobile Dropdown */}
        {isMenuOpen && (
          <div className="absolute top-full left-0 right-0 mt-4 p-8 bg-[#0A0A1F]/95 backdrop-blur-xl border border-white/10 rounded-[2rem] md:hidden animate-in slide-in-from-top-4 duration-300 shadow-2xl">
            <div className="flex flex-col gap-8 text-center">
              ...
              <Link onClick={() => setIsMenuOpen(false)} href="https://calendar.google.com/calendar/u/2?cid=dGVjbm9hcnRpZmljaWFsb2ZpY2lhbEBnbWFpbC5jb20" target="_blank" className="bg-primary hover:bg-primary/90 text-white py-5 rounded-2xl font-black text-lg shadow-lg shadow-primary/20 transition-all active:scale-95">
